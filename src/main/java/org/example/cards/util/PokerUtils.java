...
public class PokerUtils {
    ...
    public static List<PokerCard> decideCardsToDiscard(PokerHand hand) {
        PokerHandType handType = handEvaluator.evaluateHand(hand);
        Map<Rank, Long> rankCounts = hand.getCards().stream()
    ...
    private static List<PokerCard> discardHighCard(PokerHand hand) {
        final Card highestCard = hand.getCards().stream()
    ...
    private static List<PokerCard> discardPair(PokerHand hand, Map<Rank, Long> rankCounts) {
    ...
    private static List<PokerCard> discardTwoPair(PokerHand hand, Map<Rank, Long> rankCounts) {
    ...
    private static List<PokerCard> discardThreeOfAKind(PokerHand hand, Map<Rank, Long> rankCounts) {
